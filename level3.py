...
timer = 30
milisec = 0
background = pygame.image.load("source/level1.jpg")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("source/enemy2.png")
        self.surf = pygame.transform.scale(self.surf, (65, 40))
...
infotext = font.render('Pro dokončení tohoto levelu potřebuješ přežít 30 sekund.', False, (255,255,255))
timetext1 = font.render("Čas: ", False, (255,255,255))

Pridat_nepritele = pygame.USEREVENT + 1
pygame.time.set_timer(Pridat_nepritele, 400)
...
while running:
    ...
    if timer < 20: #hodnota 20, kvuli testovani
        import win
        win
        running = False
