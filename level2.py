...
timer = 55
milisec = 0
background = pygame.image.load("source/level2.jpg")
...
class Hrac(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.transform.scale(self.surf, (90, 55))
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.image.load("source/enemy1.png")
        self.surf = pygame.transform.scale(self.surf, (55, 30))
...
infotext = font.render('Pro dokončení tohoto levelu potřebuješ přežít 55 sekund.', False, (255,255,255))
timetext1 = font.render("Čas: ", False, (255,255,255))

Pridat_nepritele = pygame.USEREVENT + 1
pygame.time.set_timer(Pridat_nepritele, 850)
...
while running:
    ...
    if timer < 45: #hodnota 45, kvuli testovani
        import level3
        level3
        running = False
